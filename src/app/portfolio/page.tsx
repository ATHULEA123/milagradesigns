        ...
        <>
            ...
            >
                <div className="container max-w-3xl px-6 text-white">
                    <h1 className="lg:text-[72px] md:text-5xl text-4xl font-medium leading-tight ml-44">Portfolio</h1>
                </div>
            </div>
            <div className="container">
                ...
                <div>
                    <div className=" flex justify-center lg:gap-20 gap-10 mt-5 lg:mt-16">
                        <Image
                            src={portfolioone}
                            width={550}
                            height={0}
                        ...
                        <div>
                            ...
                            <p className="max-w-[500px] font-normal lg:text-[16px] text-xs leading-7">Milagra Designs creates spaces that tell your story with timeless aesthetics and personalized touches.
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3  lg:my-10 my-5 place-items-center">
                        <div className="flex flex-col gap-4">
                            ...
                            <p className="text-center text-[#525252] flex justify-center items-center gap-2 font-normal text-xl"><LuSquareArrowOutUpRight />2150 sq.ft</p>
                        </div>
                        <div className="flex flex-col gap-4">
                            <Image
                                src={portfoliotwo}
                            ...
                            <p className="text-center text-[#525252] flex justify-center items-center gap-2 font-normal text-xl"><SlCalender />2024</p>
                        </div>
                        <div className="flex flex-col gap-4">
                            <Image
                                src={portfoliothree}
                            ...
                            />
                            <p className="text-center text-[#525252] flex justify-center items-center gap-2 font-normal text-xl"><MdOutlineBedroomChild />3 BHK</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3  lg:mt-10 mb-28 my-5 place-items-center">
                        <div className="flex flex-col gap-4">
                            <Image
                                src={portfoliotwo}
                                width={400}
